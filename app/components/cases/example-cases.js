...
import example1 from '../../images/IMG_1355.JPG';
import example2 from '../../images/83756755-E0B1-4A26-AE1D-F34E606A91D4.JPG';
import example4 from '../../images/7A510D3E-ED69-4A20-AE8A-A2AE603C155C.JPG';
import example3 from '../../images/IMG_1394.JPG';
        ...
        <>
            ...
            <div className={styles.example}>
                <div className={styles.example__container}>
                    <h2 className={styles.example__title}>Примеры работ</h2>
                    <div className={styles.example__list}>
                        <div className={styles.example__item}>
                            <Image className={styles.example__img} src={example1}/>
                            <div className={styles.example__text}>
                                <h3 className={styles.text__title}>
                                    Замена и настройка Платы управления промышленного Ларя полностью.
                                </h3>
                                <h4 className={styles.text__desc}>
                                    Каждый холодильник чем то управляется. Он как-то понимает, когда нужно выключить мотор, отдохнуть и т.п. В этом Ларе, за это отвечает модуль управления, который совершенно случайно залили водой. Нужно было сделать новый корпус, новую плату управления и новые кнопки регулировки. Так же необходимо корректно настроить
                                </h4>
                            </div>
                            <Image className={styles.example__img} src={example2}/>
                        </div>
                        <div className={styles.example__item}>
                            <Image className={styles.example__img} src={example3}/>
                            <div className={styles.example__text}>
                                <h3 className={styles.text__title}>
                                    Один из видов работ - Утечка в запененной части.
                                </h3>
                                <h4 className={styles.text__desc}>
                                    Называется, потому что Не выдержала трубка и находиться она за хорошим слоем уплотнителя. В холодильнике, около 20 метров трубок ( бывает и больше ) Когда случается такое, необходимо аккуратно ( не повредив трубки, а это сложно ) найти утечку и решить что с ней делать. В данном случае, утечка была в центре испарителя, потому заменили целый блок. Прошло около 2-ух лет, все прекрасно работает и удовлетворяет :)
                                </h4>
                            </div>
                            <Image className={styles.example__img} src={example4}/>
                        </div>
                    </div>

                </div>
            </div>
            <div className={`${styles.example} ${styles.example2}`}>
                <div className={styles.example__container}>
                    <div className={`${styles.example__list} ${styles.example__list_row}`}>
                        <div className={styles.example__item}>
                            <Image className={styles.example__img} src={example1}/>
                            <div className={styles.example__text}>
                                <h3 className={styles.text__title}>
            ...
            <div className={`${styles.example} ${styles.example3}`}>
                <div className={`${styles.example__container} ${styles.gridgap}`}>
                    <div className={`${styles.example__list} ${styles.example__list_row2}`}>
                        <div className={styles.example__item}>
                            <Image className={styles.example__img} src={example1}/>
                            <div className={styles.example__text}>
                                <h3 className={styles.text__title}>
